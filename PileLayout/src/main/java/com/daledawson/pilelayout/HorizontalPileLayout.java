package com.daledawson.pilelayout;
 ...
 * 修改备注：
 */
public class HorizontalPileLayout extends ViewGroup {
    ...
    public HorizontalPileLayout(Context context) {
        this(context, null);
    }

    public HorizontalPileLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HorizontalPileLayout(Context context, AttributeSet attrs, int defStyleAttr) {
