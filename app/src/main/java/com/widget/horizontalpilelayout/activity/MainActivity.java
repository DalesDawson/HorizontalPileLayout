...
import com.widget.horizontalpilelayout.util.Utils;
import com.widget.horizontalpilelayout.widget.FadeTransitionImageView;
import com.widget.horizontalpilelayout.widget.HorizontalTransitionLayout;
import com.widget.horizontalpilelayout.widget.VerticalTransitionLayout;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pileLayout = (HorizontalPileLayout) findViewById(R.id.pileLayout);
        ...
        initDataList();
        pileLayout.setAdapter(new HorizontalPileLayout.Adapter() {
            @Override
            ...
            public void bindView(View view, int position) {
                ...
                Picasso.get().load(dataList.get(position).getCoverImageUrl()).into(viewHolder.imageView);
            }
